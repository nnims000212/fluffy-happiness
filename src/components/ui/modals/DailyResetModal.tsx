...
import type { FocusHistory } from '../../../types/index';
...
const DailyResetModal: React.FC<DailyResetModalProps> = ({ isOpen, onClose }) => {
    ...
    console.log('[Daily Reset Modal Debug] isOpen:', isOpen);
    
    if (!isOpen) return null;

    const focusTasks = getTodaysFocusTasks();
    console.log('[Daily Reset Modal Debug] Focus tasks found:', focusTasks);
                ...
                <div className="reset-summary">
                    ...
                    {incompleteTasks.length > 0 && (
                        <div>
                            ...
                            <ul style={{margin: '0.5rem 0', paddingLeft: '1.5rem', color: 'var(--text-color)'}}>
                                {incompleteTasks.map(task => (
                                    <li key={task.id} style={{marginBottom: '0.25rem'}}>
                                        <strong>#{task.focusOrder}:</strong> {task.text}
                                    </li>
                                ))}
                            </ul>
                        </div>
                ...
                <div className="reset-options">
                    ...
                    <label className="reset-option">
                        ...
                        <div className="option-content">
                            ...
                            <p>Remove completed tasks, keep incomplete ones in your Top 3</p>
                        </div>
                    </label>
                    ...
                    <label className="reset-option">
                        ...
                        <div className="option-content">
                            ...
                            <p>Remove all tasks and start with an empty Top 3</p>
                        </div>
                    </label>
